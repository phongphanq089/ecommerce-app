...
const Header = () => {
  ...
  return (
    <header
      className={`fixed w-full transition-03s left-0 z-50  backdrop-blur-3xl shadow-sm rounded-[100px] ${
        isFixedMenu ? 'top-0 bg-white ' : 'top-2 bg-transparent'
      }`}
    >
      <div ref={heaerRef} className='relative transition-03s'></div>
