          ...
          <div className='container-3xl flex justify-between'>
            ...
            <div className='flex items-center gap-4 md:gap-5 '>
              ...
              <div className='hidden xl:flex items-center gap-2 '>
                <span className='text-[18px] font-bold'>FREE SHIPPING</span>
              ...
              <div className='flex items-center text-xs cursor-pointer relative '>
                ...
                <span className=' w-4 h-4 flex items-center justify-center bg-color-1 rounded-full absolute -top-1 -right-1 text-white font-bold text-[18px]'>
                  1
                </span>
              </div>
              ...
              <div
                className='flex items-center gap-1  md:px-3 md:py-2  cursor-pointer'
              ...
              >
                <div className='flex items-center border border-black'>
                  <svg
                    ...
                    className='icon icon-tabler icons-tabler-outline icon-tabler-menu w-5 h-5'
                  >
                ...
                <span className='hidden md:block font-bold text-sm'> Menu</span>
              </div>
            </div>
          </div>
        </nav>
